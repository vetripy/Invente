...
class Event(models.Model):
    ...
    team_size = models.IntegerField(MinValueValidator(0))
    depts = (
    ...
    first_prize = models.IntegerField(MinValueValidator(0))
    second_prize = models.IntegerField(MinValueValidator(0))
    third_prize = models.IntegerField(MinValueValidator(0))
